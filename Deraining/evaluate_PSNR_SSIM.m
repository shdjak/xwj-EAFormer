...
for idx_set = 1:num_set
    file_path = strcat('D:/pycharm_code/Restormer/Deraining/results/', datasets{idx_set}, '/');
    gt_path = strcat('D:/pycharm_code/Restormer/Deraining/Datasets/test/', datasets{idx_set}, '/target/');
